...
@interface FNTableViewController () <FNTransitioningDelegate>
...
{
    if (!_imageArray) {
        UIImage *image1 = [UIImage imageNamed:[self imageBundleUrlString:@"icon_imaging"]];
        UIImage *image2 = [UIImage imageNamed:[self imageBundleUrlString:@"icon_return"]];
        UIImage *image3 = [UIImage imageNamed:[self imageBundleUrlString:@"icon_setting"]];

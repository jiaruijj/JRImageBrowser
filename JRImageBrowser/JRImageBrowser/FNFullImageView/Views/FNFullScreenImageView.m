...
- (void)updateWithImage:(FNFullScreenImage *)fullImage completion:(void (^)(NSError *))completion
{
    if (fullImage.image) {
        ...
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:fullImage.imageURLString] placeholderImage:[UIImage imageNamed:@"icon_imaging"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
